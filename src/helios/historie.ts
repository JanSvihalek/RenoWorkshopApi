...
const SLOUPCE: Sloupec[] = [
  ...
  { nazev: "pojistovna_id", typ: "int" },
  { nazev: "cislo_poradace", typ: "int" },
  { nazev: "cislo_pu", typ: "nvarchar(100)" },
...
export function radekHistorie(z: ZakazkaZHeliosu, ted: Date): Radek {
  return {
    ...
    pojistovna_id: cislo(z.pojistovna1),
    cislo_poradace: cislo(z.cislo_poradace),
    cislo_pu: cisloPu(z),
